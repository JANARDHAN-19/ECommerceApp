...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=HP\\SQLSERVERDEV; Database=EcommerceDB; Trusted_Connection=True; TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Address>(entity =>
        {
            entity.HasKey(e => e.AddressId).HasName("PK__Addresse__091C2A1B878AEBBA");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2BB65F64EB");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B8DF35BB14");

            entity.HasIndex(e => e.Email, "UQ__Customer__A9D105349FA1D131").IsUnique();
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAFAB60E464");
        ...
        {
            entity.HasKey(e => e.OrderItemId).HasName("PK__OrderIte__57ED06A158628B2F");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__9B556A586AA5D3A3");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED74F78C51");
